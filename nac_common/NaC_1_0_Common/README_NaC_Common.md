					...
					<details>
						...
						<blockquote>
							...
							<tr>
								...
								<code>- This example creates 3 users:</code>
								<code>• one user with NETWORK-ADMIN-ROLE</code> 
								<code>• one user with OBSERVER-ROLE</code> 
								<code>• one user with ASSURANCE-ROLE (new customized role)</code> 
